...
class CategoryPickerDialogFilter extends StatefulWidget {

  const CategoryPickerDialogFilter({
    Key? key,
  }) : super(key: key);


  @override
  State<CategoryPickerDialogFilter> createState() => _CategoryPickerDialogFilterState();
}

class _CategoryPickerDialogFilterState extends State<CategoryPickerDialogFilter> {
