                                          ...
                                          Column(
                                            children: [
                                              Column(crossAxisAlignment: CrossAxisAlignment.center,
                                                children: [
                                                  IconButton(highlightColor: Colors.green,color: Colors.black54, onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => EditRecord(index: index, marker: marker))); }, icon: const FaIcon(FontAwesomeIcons.pencil),),
                                                ],
                                              ),
                                              Column(crossAxisAlignment: CrossAxisAlignment.center,
                                                children: [
